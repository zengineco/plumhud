...
ring — pie-ring, one segment per miner, summary in center donut
bar  — horizontal hash-rate bars
spark — mini sparklines from last 1h DB history
grid — compact 4-column status tiles, up to 32 miners
...
v3.0.0 — 2026 — Async engine, SQLite, 4 HUD modes, alert engine, Discord/Telegram, skin presets, opacity control, 5-tab Command Center
v2.0.0 — 2026 — Zengine standard rebuild, fixed math import, thread-safe UI refresh
v1.0.0 — 2025 — ChatGPT-era original
